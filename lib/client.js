...
function writeHttp (path, url, options, cb) {
    ...
    uri
    , (window.fs.root.toURL() === 'undefined/') ? path : window.fs.root.toURL() + newPath // window.fs.root.toURL() === 'undefined/' on Windows Phone 8. Really? Really.
    , function (entry) {
